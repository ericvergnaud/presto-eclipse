...
import core.runtime.IParser;

public class ContentProvider implements ITreeContentProvider {

	static enum ContentType {
		ATTRIBUTE(PrestoConstants.ATTRIBUTE_ICON),
		CATEGORY(PrestoConstants.CATEGORY_ICON),
		ENUMERATED(PrestoConstants.ENUMERATED_ICON),
		SYMBOL(PrestoConstants.SYMBOL_ICON),
		METHOD(PrestoConstants.METHOD_ICON);
