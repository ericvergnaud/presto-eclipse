...
public class ColorConstants {
	...
	public static final RGB COMMENT = new RGB(63, 127, 195);
	public static final RGB KEYWORD = new RGB(127, 0, 85);
	public static final RGB TYPE = new RGB(63, 63, 191);
	public static final RGB SYMBOL = new RGB(0, 0, 192);
	public static final RGB LITERAL = new RGB(127, 159, 191);
	public static final RGB BRANCH = new RGB(42, 0, 255);
	public static final RGB LOOP = new RGB(64, 128, 0);
}
